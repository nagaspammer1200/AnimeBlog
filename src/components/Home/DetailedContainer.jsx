        ...
        <div className="sm:pl-36 m-16 p-6 bg-gradient-to-r from-pink-400 to-pink-600 rounded">
            ...
            <div className="flex-col sm:flex sm:flex-row space-x-0 sm:space-x-16 p-3"> 
                <div className="font-bold">
                    <div><img src={DImage} alt={DAlt} width="150px" height="150px" /></div>
            ...
            <div className="mb-4"><h4><a href={DSteam}><img src="https://firebasestorage.googleapis.com/v0/b/animeblog-56aed.appspot.com/o/icons%2Fsteam_icon_135152.png?alt=media&token=c998d50f-8913-42d4-a03f-1ff2e5690d94" alt="" /></a></h4></div>
        </div>
        <hr />
    </React.Fragment>
  )
