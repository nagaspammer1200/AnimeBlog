...
function MainSection() {
  ...
  <isVisibleGenshinContext.Provider value={{isVisibleGenshin,setIsVisibleGenshin,isVisibleHalf,setIsVisibleHalf,isVisibleForza,setIsVisibleForza,isVisibleNeed,setIsVisibleNeed,setIsVisibleArise,setIsVisibleMount,isVisibleContainer,setIsVisibleContainer}}>
    <React.Fragment>
      <div className={isVisibleContainer?"hidden":"text-center text-bold text-3xl pt-8 hover:text-white transistion delay-110 duration-300 ease-in-out hover:-translate-y-2 hover:scale-120"}><h4>Popular Games</h4></div>
      <div className={isVisibleContainer?"hidden":"grid grid-cols-1 sm:grid-cols-2 gap-x-2 ps-10 sm:ps-32 mb-3"}>
      ...
      <div className={isVisibleContainer?"hidden":"text-center text-bold text-3xl pt-8 hover:text-white transistion delay-110 duration-300 ease-in-out hover:-translate-y-2 hover:scale-120"}><h4>New Games</h4></div>
