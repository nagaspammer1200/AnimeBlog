  ...
  return (
    <React.Fragment>
        <div className={displayMode?"border-black border-b-2 flex flex-col space-y-0 sm:space-y-0 sm:flex-row items-center justify-evenly font-bold text-fuchsia-600 pt-4":"border-black border-b-2 flex flex-col space-y-1 sm:space-y-0 sm:flex-row items-center justify-evenly font-bold text-fuchsia-600 pt-4"}> 
            ...
            <div className={displayMode?"p-2 sm:block rounded-md bg-neutral-50 hover:bg-neutral-300":"rounded-xl hidden sm:block p-2 bg-neutral-50 hover:bg-neutral-300 "}><a href="/latest">Latest News</a></div>
            ...
            <div className={displayMode?"p-2 sm:block rounded-md bg-neutral-50 hover:bg-neutral-300":"rounded-xl sm:block hidden p-2 bg-neutral-50 hover:bg-neutral-300 "}><a href="#">Episode Reviews</a></div>
        </div>
    </React.Fragment>
  )
}
